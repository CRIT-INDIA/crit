...
const ServicesBlock = () => {
  ...
  const getFeatureAnimation = (feature) => {
  ...
  const statsAnimations = {
    ...
    support: "https://res.cloudinary.com/duz9xipfm/raw/upload/v1751617562/ttt_pn0kug.json" // Support centre animation
  };

  const processAnimations = {
    assessment: "https://assets9.lottiefiles.com/packages/lf20_5tl1xxnz.json", // Assessment/Analysis
    planning:"https://assets9.lottiefiles.com/packages/lf20_5tl1xxnz.json",
      ...
      .then(data => {
        ...
        if (serviceData?.features) {
          const initialFeatures = serviceData.features.map(feature => ({
            ...
            color: "bg-white", // Use white background for all cards
          }));
          console.log('Loaded features with animations:', initialFeatures);
  ...
  useEffect(() => {
    ...
    if (newService?.features) {
      ...
      console.log('Updated features with animations:', updatedFeatures);
  ...
  return (
    <div className="bg-[#0C1C3C] text-white">
      ...
      {/* Hero Section */}
      <section className="relative w-full px-6 py-16 bg-cover bg-center min-h-* min-w-* overflow-hidden "
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {faqData.map((faq, index) => (
            ...
            >
              ...
              <div className={`transition-all p-10 duration-300 ${openFAQ === index ? 'max-h-none opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="p-10 px-8 pb-6">
        ...
        <div className="text-center mt-12 cursor-pointer">
          ...
          <button className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-500/25 cursor-pointer">
            Contact Support
          </button>
        </div>
      </section>
