...
export default function CritIndiaCtaForm({ onClose }) {
  ...
  return (
    <>
      <ModalPortal>
      <div className="fixed inset-0 backdrop-blur-sm bg-opacity-70 overflow-y-auto p-3 z-50 flex justify-center items-center animate-in fade-in duration-300">
        <div className="cta-modal-content w-full max-w-2xl h-fit bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 rounded-xl overflow-hidden shadow-2xl border border-blue-800 animate-in slide-in-from-bottom-4 duration-500 ease-out">
          {/* Header Section */}
          <div className="relative p-4 text-white" style={{ background: 'linear-gradient(90deg, #1B2433 0%, #0974C7 100%)' }}>
            <button
              onClick={handleClose}
              className="absolute top-3 right-3 text-white hover:text-red-200 transition-all duration-200 hover:scale-110 hover:rotate-90"
          ...
          <div className="flex flex-col lg:flex-row">
            {/* Left Side - Benefits */}
            <div className="lg:w-2/5 p-4 bg-gradient-to-b from-slate-800 to-slate-900 text-white relative overflow-hidden">
              <h3 className="text-base font-semibold mb-3 text-blue-400 relative z-10">Why Choose CRIT India?</h3>
              ...
              <div className="bg-slate-700 rounded p-2 border border-slate-600 relative z-10">
            ...
            {/* Right Side - Form */}
            <div className="lg:w-3/5 p-4 bg-slate-900 text-white">
              {submitted ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-300 mb-2 text-sm">Our SAP specialists will contact you within 24 hours.</p>
                  <p className="text-xs text-gray-400">This window will close automatically...</p>
                </div>
              ) : (
                <div className="space-y-2.5">
                  <h3 className="text-base font-semibold text-blue-400 mb-3">Schedule Your Free Consultation</h3>
