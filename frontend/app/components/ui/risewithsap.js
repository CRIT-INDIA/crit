    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-16">
          <h2 className={`text-6xl sm:text-6xl lg:text-5xl font-bold text-white mb-2 md:mb-6 transition-all duration-1000 ${
            hasBeenVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10' 
          }`}>
            Rise with SAP
          </h2>
          <p className={`text-base md:text-md text-gray-400 max-w-xl mx-auto leading-relaxed transition-all duration-1000 delay-300 px-4 ${
            hasBeenVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
